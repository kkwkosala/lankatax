  ...
  template: `
    <div class="min-h-screen flex items-center justify-center p-4">
      <mat-card class="w-full max-w-md shadow-lg">
        <mat-card-header>
          <mat-card-title class="text-2xl font-bold">Create Account</mat-card-title>
          <mat-card-subtitle>Save and track your salary calculations</mat-card-subtitle>
        </mat-card-header>
        ...
        <mat-card-actions class="px-4 pb-4">
          <p class="text-sm text-gray-600 text-center">
            Already have an account? <a routerLink="/auth/login" class="text-primary-600 font-medium">Sign in</a>
          </p>
        </mat-card-actions>
      </mat-card>
    </div>
